...
class BaseProcessor(ABC):
    ...
    def get_train_loader(self, batch_size, shuffle=True, collate_fn=None):
    ...
    def get_val_loader(self, batch_size, shuffle=False, collate_fn=None):
    ...
    def get_test_loader(self, batch_size, shuffle=False, collate_fn=None):
